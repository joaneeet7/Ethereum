...
contract Food {
    ...
    function newPlate(string memory _name, string memory _ingredients)
        internal
    {
...
contract Hamburger is Food {
    ...
    function doHamburguer(string memory _ingredients, uint256 _units) external {
        require(_units <= 5, "Cheeseburger without cheese, bad idea!");
    ...
    modifier onlyOwner() {
        require(
            owner == msg.sender,
            "You do not have permissions to execute this function"
        );
        _;
    }
}
